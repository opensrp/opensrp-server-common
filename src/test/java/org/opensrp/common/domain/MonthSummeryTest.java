...
public class MonthSummeryTest {
	...
	public void testForConstructorAndGettersOfMonthSummery() {
		...
		monthSummary = new MonthSummary("July", "2017", "73%", "47%", externalIDs);
		monthSummary2 = new MonthSummary("august", "2018", "63%", "37%", externalIDs);
	...
	public void equalsContract() {
		EqualsVerifier.forClass(MonthSummary.class).verify();
	}
